...
import { rightPagePhotoStyle, paperInkStyle, paperVignetteStyle } from "./paperPage";

export default function RightPage({ mission }: { mission: Mission }) {
  return (
    <div className="relative h-full p-8 md:p-10 lg:p-12" style={{ ...rightPagePhotoStyle, ...paperInkStyle }}>

...
export default function JourneyPanelTest({
  stage,
  onClose,
}: {
  stage: Stage | null;
    ...
    <AnimatePresence>
      ...
      {stage && (
        <motion.div
          ...
          className="fixed inset-y-0 right-0 z-50 w-full sm:w-[420px] md:w-[480px] overflow-y-auto border-l border-hairline"
          style={{ background: "rgba(16, 14, 11, 0.92)", backdropFilter: "blur(6px)" }}
